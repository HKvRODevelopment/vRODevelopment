...
export function createVirtualEthernetCardDvNetworkConfigSpec_1(dvPortgroup?: VC.DistributedVirtualPortgroup, macAddress?: string): any {// Create connectable info for dvPortgroup
...
System.log("Added vmxnet3 vNIC to correct portgroup complete");
}
}
